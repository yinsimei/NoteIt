...
public:
    Task(int i, const QDateTime & dc, const string &t):
        Note(i, dc, t), action(""), priority(highest), deadline(QDateTime.currentDateTime()), taskStatus(notStarted) {}
    ...
    const string &getAction() const {retrun action; }
    ...
    void setAction(const string &tx) { text = tx; }
